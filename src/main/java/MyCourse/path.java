...
//         clickingReport.click ();
                ...
                System.out.println ( "Article Page Is Not Opened" );
            }
    ...
    public void PathEbooks() throws InterruptedException {
        ...
        if (noRecordFoundDisplayed) {
            ...
            if (clickingCommentIcon.isDisplayed ()) {
                ...
                System.out.println ( "Ebook Page Is Not Opened " );
            }
...
//            clickingReport.click ();
                ...
                System.out.println ( "Start Button Clicked But The quiz page is not opened" );
            }
    ...
    public void resumequiz() throws InterruptedException {
        ...
        if (noRecordFoundDisplayed) {
            ...
            if (clickingTheInstructionIcon.isDisplayed ()) {
                ...
                System.out.println ( "Resume Button Is Clicked, But The Page Is Not Opened" );
            }
    ...
    public void solutionpath() throws InterruptedException {
        ...
        if (noRecordfoundDisplayedInPath) {
            ...
            System.out.println ( "No Record Found Was Displayed" );
            ...
            if (scrollToReportIcon.isDisplayed ()) {

                scrollToReportIcon = driver.findElement ( xpath ( "//*[@class=\"report\"]" ) );
                Actions actions = new Actions ( driver );
                actions.scrollToElement ( scrollToReportIcon ).perform ();
                scrollToReportIcon.click ();
                ...
                System.out.println ( "Solution Button Clicked But The page is not opened" );
            }
