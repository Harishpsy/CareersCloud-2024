...
//                System.out.println ( "-------------------------------------------------------------------------" );
    ...
    private void quizStart() throws InterruptedException {
        ...
        if (noRecordfoundDisplayedInMyNotes) {
            System.out.println ( "No records found message is displayed In Quiz." );
...
//                System.out.println ( "Verification Passed: Quiz Title In All (" + QuizTitle + ") matches Quiz Title In Paused (" + quiztitleText + ")" );
//            }
    ...
    private void resumeQuiz() throws InterruptedException {
        ...
        try {
            ...
            quizresumeDisplayedInMyNotes = resumequiz.isDisplayed ();
        } catch (NoSuchElementException e) {
        ...
        if (noRecordfoundDisplayedInMyNotes) {
            System.out.println ( "No record was not found" );
...
//              System.out.println ( "Quiz Title " + quiztitleText );
    ...
    private void quizSolution() throws InterruptedException {
        ...
        try {
            noRecordfoundDisplayedInAllQuiz = noRecordfoundMyNotes.isDisplayed ();
        } catch (NoSuchElementException e) {
            System.out.println ( "noRecordFound element not found In My Notes." );
        }
        ...
        // Log the visibility status of each element
        System.out.println ( "noRecordFound displayed In My Notes: " + noRecordfoundDisplayedInAllQuiz );
        System.out.println ( "Solution button displayed In My Notes: " + quizsolutionDisplayedInAllQuiz );

        if (noRecordfoundDisplayedInAllQuiz) {
            System.out.println ( "No Record Found is not Displayed" );
