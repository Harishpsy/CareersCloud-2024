...
public class quizzesUnattemptedSubModule {
    ...
    public void unAttempted() throws InterruptedException {
        ...
        clickingTheUnAttemptedTab.click ();
        ...
        // Verifying the Quiz List was getting duplicating Or Not
    ...
    private void quizStart() throws InterruptedException {
        ...
        try {
            ...
            System.out.println ( "noRecordFound element not found In Unattempted QUiz Page." );
        }
        ...
        try {
            ...
            System.out.println ( "StartQuiz element not found In Unattempted QUiz Page." );
        }

        // Log the visibility status of each element
        System.out.println ( "noRecordFound displayed In Unattempted QUiz Page: " + noRecordfoundDisplayedInQuizListPage );
        System.out.println ( "StartQuiz displayed In Unattempted QUiz Page: " + quizStartDisplayed );
        ...
        if (noRecordfoundDisplayedInQuizListPage) {
            ...
            System.out.println ( "No records found message is displayed In Unattempted List Page, Navigating to The Attempted Tab" );
    ...
    private void resumeQuiz() throws InterruptedException {
        ...
        if (quizresumeDisplayedInQuizListPage) {

            Thread.sleep ( 3000 );
            WebElement resumequiz = driver.findElement ( xpath ( "//*[@class=\"ant-btn css-xu9wm8 ant-btn-default ant-btn-background-ghost ant-btn-block quiz-attempt2-button\"]/child::span[text()=' Resume ']" ) );
            resumequiz.click ();
            System.out.println ( "Successfully clicked the Resume button In The Paused quiz List Page." );
