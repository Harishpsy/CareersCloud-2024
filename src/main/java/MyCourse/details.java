...
public class details extends ScreenShot {
    WebDriver driver;
    ...
    public void details() throws InterruptedException, AWTException, IOException {
        try {
            ...
            // Check if the "Details" tab is displayed but not selected
                ...
                captureScreenShot ( "clicked the Details page." );
    ...
    @Test(enabled = true)
    public void emialIcon() throws InterruptedException, AWTException, IOException {
        ...
        if (emailIconDisplayed) {
            ...
            captureScreenShot ( "Clicked the Email Icon." );
...
//         clickingSendButton.click ();
            ...
            captureScreenShot ( "Clicked Cancel Icon." );
    ...
    @Test(enabled = true)
    public void phoneIcon() throws InterruptedException, IOException {
        ...
        try {
            ...
            if (phoneIconDisplayed) {
                ...
                captureScreenShot ( "Clicked The Phone Icon." );
    ...
    @Test(enabled = true)
    public void whatsAppChat() throws InterruptedException, IOException {
        ...
        if (whatsappChatIconDisplayed) {
            ...
            captureScreenShot ( "Clicked The Whatsapp Chat icon." );
